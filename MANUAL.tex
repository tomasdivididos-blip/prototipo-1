...
\begin{titlepage}
  ...
  \vspace{0.3cm}
  {\normalsize Versión del Manual 2.21 — 31 de Julio de 2026\par}
  \vspace{0.5cm}
...
\begin{center}
  \small\textcolor{cGray}{%
    ...
    Manual de Usuario $\cdot$ v2.21 $\cdot$ 31 de Julio de 2026\\[2pt]
    ...
    es de v2.16; parches y muebles se agregaron despues).%
  }
\end{center}
