...
\begin{titlepage}
  ...
  \vspace{0.3cm}
  {\normalsize Versión del Manual 2.16 — 5 de Julio de 2026\par}
  \vspace{0.5cm}
...
\textbf{Para agregar materiales propios:} copiar un archivo \texttt{.json}
a la carpeta \texttt{materials/} y presionar \menu{Recargar materiales}.
...
\begin{center}
  \small\textcolor{cGray}{%
    ...
    Manual de Usuario $\cdot$ v2.14 $\cdot$ 27 de Junio de 2026\\[2pt]
