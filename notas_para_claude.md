...
Todo compila (`py_compile`) y el usuario probó en GUI (6/9/1/8/2/5/3/7 + «?» + 4a + FEM). Falta solo la **4b** (flechas grises para ciclar pared/esquina; defaults en `plan_mejoras_ux.md`). Núcleo físico intacto (render/atajos/UI = presentación).
