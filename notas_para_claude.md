...
Todo compila (`py_compile`) y el usuario probó en GUI (6/9/1/8/2/5/3/7 + FEM). Falta solo la **4** (cámaras P/I/L + flechas, la grande, defaults acordados en `plan_mejoras_ux.md`). Núcleo físico intacto (render/atajos/UI = presentación).
